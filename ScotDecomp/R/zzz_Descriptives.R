...
if (me == "mpidr_d\\seaman"){
	setwd("U:/Publications/2017/Within and between group/ScotDecomp")
}
...
SCO     <- read.csv("Data/Inputs/lifetables_quintiles_scotland.csv")
SCOlong <- local(get(load("Data/Derived/SCOlong.Rdata")))
...
# save to csv
write.csv(SCOcsv, file = "Data/Derived/descriptives.csv", row.names = FALSE)
# -----------------------------------
